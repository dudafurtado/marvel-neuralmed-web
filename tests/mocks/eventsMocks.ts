export const mockEvents = [
  {
    ...
    urls: [
      {
        type: 'detail',
        url: 'http://marvel.com/comics/events/269/secret_invasion?utm_campaign=apiRef&utm_source=91532ae9fb47f72c086e9a07b4c3a2c8',
      },
      {
        type: 'wiki',
        url: 'http://marvel.com/universe/Secret_Invasion?utm_campaign=apiRef&utm_source=91532ae9fb47f72c086e9a07b4c3a2c8',
      },
    ],
    ...
    creators: {
      ...
      items: [
        ...
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/creators/8193',
          name: 'Carrie Beadle',
          role: 'other',
        },
        {
    ...
    comics: {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'AVENGERS: THE INITIATIVE VOL. 3 - SECRET INVASION TPB (Trade Paperback)',
        },
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/comics/24299',
          name: 'AVENGERS: THE INITIATIVE VOL. 3 - SECRET INVASION TPB [DM ONLY] (Trade Paperback)',
        },
        {
        ...
        },
        {
          ...
          name: 'CAPTAIN BRITAIN AND MI13 VOL. 1: SECRET INVASION TPB (Trade Paperback)',
        },
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/comics/23695',
          name: 'CAPTAIN BRITAIN AND MI13 VOL. 1: SECRET INVASION TPB [DM ONLY] (Trade Paperback)',
        },
        {
    ...
    series: {
      ...
      items: [
        ...
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/36264',
          name: 'AVENGERS: THE INITIATIVE VOL. 3 - SECRET INVASION TPB (2009)',
        },
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/7496',
          name: 'AVENGERS: THE INITIATIVE VOL. 3 - SECRET INVASION TPB [DM ONLY] (2009 - Present)',
        },
        {
        ...
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/33897',
          name: 'CAPTAIN BRITAIN AND MI13 VOL. 1: SECRET INVASION TPB (2009)',
        },
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/6849',
          name: 'CAPTAIN BRITAIN AND MI13 VOL. 1: SECRET INVASION TPB [DM ONLY] (2009 - Present)',
        },
        {
        ...
        },
        {
          ...
          name: 'DEADPOOL VOL. 1: SECRET INVASION PREMIERE HC (2009 - Present)',
        },
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/7714',
          name: 'DEADPOOL VOL. 1: SECRET INVASION TPB [DM ONLY] (2009 - Present)',
        },
        {
        ...
        {
          resourceURI: 'http://gateway.marvel.com/v1/public/series/6442',
          name: 'Mighty Avengers Vol. 3: Secret Invasion Book 1 Premiere (2008 - Present)',
        },
      ],
      returned: 20,
    },
...
export const mockEventsDataCleaned = [
  {
    id: 269,
    title: 'Secret Invasion',
    description:
      "The shape-shifting Skrulls have been infiltrating the Earth for years, replacing many of Marvel's heroes with impostors, setting the stage for an all-out invasion.",
    src: 'http://i.annihil.us/u/prod/marvel/i/mg/6/70/51ca1749980ae.jpg',
  },
];
